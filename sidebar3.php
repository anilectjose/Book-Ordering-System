...
include 'db2.php';
$rol=mysqli_query($con,"SELECT * FROM role_db WHERE role_id='$uid'");
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="user_dashboard.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">BRS User</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php echo $p['uname'];?></a>
        </div>
        <?php } ?>
      </div>
